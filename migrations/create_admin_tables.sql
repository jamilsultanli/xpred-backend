...
-- with role-based access control, audit logging, and management features
...
-- ADMIN ROLES TABLE
-- =====================================================
-- Defines different admin role levels with hierarchical access
...
-- =====================================================
-- Granular permissions for each role on different resources
...
-- =====================================================
-- Configurable platform settings managed by admins
...
-- =====================================================
-- Admins can add notes/warnings about specific users
...
-- =====================================================
-- User-submitted prediction resolutions awaiting admin review
...
CREATE INDEX IF NOT EXISTS idx_profiles_admin_role ON profiles(admin_role_id);
